        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-2 border rounded-lg bg-indigo-300 text-white font-semibold"
            />
          </div>
          ...
          <button type="submit" className="w-full bg-indigo-500 text-white p-3 rounded-lg hover:bg-indigo-700">
            Update
          </button>
        </form>
      )}
